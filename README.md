...
Created and updated automatically by [around-the-word](https://github.com/nbr23/around-the-word) when generating the map. Maps author names to country names, used for country flag display.
